...
const TopCarousel = () => {
  ...
  const settings = {
    ...
    slidesToShow: 1,
    centerMode: true,
    centerPadding: "100px", // Show partial images with enough gap
    autoplay: true,
    autoplaySpeed: 2000,
    nextArrow: <NextArrow />,
    prevArrow: <PrevArrow />,
    responsive: [
      ...
      },
      {
        ...
        settings: {
          slidesToShow: 1,
          centerMode: false, // Only show one image at a time
      ...
      <Slider {...settings}>
        {carouselItems.map((item, index) => (
          <Box
            ...
            sx={{
              position: "relative",
              outline: "none", // Prevent the blue focus border
              padding: { xs: 0, md: "0 10px" }, // Gap between slides
            }}
          >
            <img
              src={item.image}
